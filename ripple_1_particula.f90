module variaveis
    ...
    integer, parameter:: ni = 5000000, ns = 1, nc = 3000, &
...
&                                beta = betadamp * damping
    ...
    doubleprecision:: fcx, fcy, aux, hx, hy, wx, vrx, vry
...
subroutine skyr_ripple(x0, y0, rx, ry, u, vry, vrx, lx, ly, ax, ay)
    implicit none
    doubleprecision:: x0, y0, rx, ry, u, vry, vrx, aux, lx, ly, ax, ay
